...
def load_rag_pipeline():
    qa_df = pd.read_csv("data/qa_clean_data.csv")
...
def generate_answer_with_gemini_streamed(question, context):
    prompt = f"""
You're a helpful assistant who answers financial questions in a way that's simple and easy to understand. Use ONLY the context provided below. Keep the answer human, and clear — like you're explaining to a friend. Avoid technical jargon.
...
st.title("RAG-based Financial Advisor")
